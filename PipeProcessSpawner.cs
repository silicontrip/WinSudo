        ...
        public SudoProcess Spawn(IntPtr userToken, string command, ProcessSpawnerOptions options)
        {
            ...
            try
            {
                ...
                var sudoProcess = new SudoProcess(
                    ...
                    stdoutPipeServer,
                    stderrPipeServer,
                    new System.IO.FileStream(new Microsoft.Win32.SafeHandles.SafeFileHandle(hParentStd_In_Wr, true), FileAccess.Write),
                    new System.IO.FileStream(new Microsoft.Win32.SafeHandles.SafeFileHandle(hParentStd_Out_Rd, true), FileAccess.Read),
                    new System.IO.FileStream(new Microsoft.Win32.SafeHandles.SafeFileHandle(hParentStd_Err_Rd, true), FileAccess.Read)
                );
